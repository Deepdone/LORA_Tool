...
NSString *completeRPCURLPath = @"/mmwebviewprogressproxy/complete";
...
@implementation MMWebViewProgress
{
...
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
    ...
    if (interactive) {
        ...
        NSLog(@"waitForCompleteJS:  %@",waitForCompleteJS);
