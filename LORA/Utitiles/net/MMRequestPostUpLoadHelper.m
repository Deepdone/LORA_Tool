...
#import "MMRequestPostUpLoadHelper.h"

@implementation MMRequestPostUpLoadHelper

static NSString * const FORM_FLE_INPUT = @"img";// 图片NSData key

/**
 *  <#Description#>
 *
 *  @param url         <#url description#>
 *  @param postParems  <#postParems description#>
 *  @param picFilePath <#picFilePath description#>
 *  @param picFileName <#picFileName description#>
...
+ (NSDictionary *)postRequestWithURL: (NSString *)url  // IN
                     ...
                     andResult:(void(^)(NSDictionary *resultDic)) resultBlock; // 返回结果
{
    ...
    if(picFilePath){
        ...
        //声明上传文件的格式
        [body appendFormat:@"Content-Type: image/jpge,image/gif, image/jpeg, image/png, image/pjpeg, image/pjpeg\r\n\r\n"];
    }
